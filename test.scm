...
(test (< 1.5700 (acos 0.00) 1.5709) #t)
(test (< 1.3180 (acos 0.25) 1.3189) #t)
(test (< 1.0470 (acos 0.50) 1.0479) #t)
(test (< 0.7220 (acos 0.75) 0.7229) #t)
(test (< 3.1410 (acos -1.00) 3.1419) #t)
(test (< 2.4180 (acos -0.75) 2.4189) #t)
(test (< 2.0940 (acos -0.50) 2.0949) #t)
(test (< 1.8230 (acos -0.25) 1.8239) #t)
(test (acos 1) 0)

(test (asin 0) 0)
(test (< 0.2520 (asin 0.25) 0.2529) #t)
(test (< 0.5230 (asin 0.50) 0.5239) #t)
(test (< 0.8479 (asin 0.75) 0.8489) #t)
(test (< 1.5700 (asin 1.00) 1.5709) #t)
(test (< -1.5709 (asin -1.00) -1.5700) #t)
(test (< -0.8489 (asin -0.75) -0.8479) #t)
(test (< -0.5239 (asin -0.50) -0.5230) #t)
(test (< -0.2529 (asin -0.25) -0.2520) #t)

(test (atan 0) 0)
(test (< 0.2440 (atan 0.25) 0.2451) #t)
(test (< 0.4630 (atan 0.50) 0.4639) #t)
(test (< 0.6430 (atan 0.75) 0.6439) #t)
(test (< 0.7850 (atan 1.00) 0.7859) #t)
(test (< -0.2451 (atan -0.25) -0.2440) #t)
(test (< -0.4639 (atan -0.50) -0.4630) #t)
(test (< -0.6439 (atan -0.75) -0.6430) #t)
(test (< -0.7859 (atan -1.00) -0.7850) #t)
