...
(test (cos -180.0) -1.0)
(test (cos -270.0) 0.0)
(test (<  0.9998476950 (cos   1)  0.9998476959) #t)
(test (<  0.7071067810 (cos  45)  0.7071067819) #t)
(test (< -0.7071067819 (cos 135) -0.7071067810) #t)
(test (< -0.7071067819 (cos 225) -0.7071067810) #t)
(test (<  0.7071067810 (cos 315)  0.7071067819) #t)
...
(test (sin -180.0) 0.0)
(test (sin -270.0) 1.0)
(test (<  0.0174524060 (sin   1)  0.0174524069) #t)
(test (<  0.7071067810 (sin  45)  0.7071067819) #t)
(test (<  0.7071067810 (sin 135)  0.7071067819) #t)
(test (< -0.7071067819 (sin 225) -0.7071067810) #t)
(test (< -0.7071067819 (sin 315) -0.7071067810) #t)
...
(test (tan -225.0) -1.0)
(test (tan -315.0) 1.0)
(test (<  0.0174550640 (tan   1)  0.0174550650) #t)
(test (<  0.4142135620 (tan  22.5)  0.4142135629) #t)
(test (< -0.4142135629 (tan 157.5) -0.4142135620) #t)
(test (<  0.4142135620 (tan 202.5)  0.4142135629) #t)
(test (< -0.4142135629 (tan 337.5) -0.4142135620) #t)
