...
#define T_BYTECODE	S9_T_BYTECODE
...
#define bytecode	s9_bytecode
#define bytecode_len	s9_bytecode_len
...
#define bytecode_p	s9_bytecode_p
...
#define GC_stkptr	S9_gc_stkptr
 ...
 #define make_bytecode		s9_make_bytecode
